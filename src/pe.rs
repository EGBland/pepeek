...
impl HeadersPe32 {
    fn new(coff_header: CoffHeader, optional_headers: OptionalHeaderPe32, data_directories: Vec<DataDirectory>, section_headers: Vec<SectionHeader>) -> Self {
        HeadersPe32 {
            coff_header,
            optional_headers,
            data_directories,
...
impl HeadersPe32Plus {
    fn new(
        ...
        optional_headers: OptionalHeaderPe32Plus,
